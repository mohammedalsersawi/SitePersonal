    ...
    <div class="modal fade" id="full-modal-stem" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('facts.store') }}" method="POST" id="add_model_form" class="add-mode-form">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="@lang('name') @lang($value)" name="value">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('facts.update') }}" method="POST" id="form_edit" class=""
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('facts.getData', app()->getLocale()) }}',
        ...
        $(document).ready(function() {
            $(document).on('click', '.edit_btn', function(event) {
                ...
                @foreach (locales() as $key => $value)
                    $('#key_{{ $key }}').val(button.data('key_{{ $key }}'))
                @endforeach
